...
Приходи, присаживайся, читай ${link(`правила`, `https://t.me/c/2000257215/800280`)} и список рекомендуемых аниме к ${link(`просмотру`, `https://t.me/c/2000257215/410`)}, а также ${link(`список проектов участников`, `https://t.me/c/2000257215/422`)} и ${link(`список их списков тайтлов`, `https://t.me/c/2000257215/425`)}.`
...
export const post =
`Правила общения в комментариях

1. Не будьте мудаком* или ваши сообщения будут удалены и вероятно вы будете забанены.
